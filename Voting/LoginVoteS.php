...
<body>
    ...
    <center>
        ...
        <?php
            ...
            echo "<br><br>";
            echo "<center style='margin-: 100px;color:red;'><h3>You Already Voted.</h3></center>";
            echo "<br><br>";
            echo '<a href="Logout.php" style="margin-left: 20px;" class="btn btn-primary"><i class="fas fa-sign-out-alt"></i> LogOut</a>';
        }
        //   session_destroy(); 
        ?>
    </center>
